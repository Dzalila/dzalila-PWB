    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">My Profil</h3>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="bio-content">
                      ...
                      <br>
                      <h5>Nama  : Dzalila Mustofa</h5><h5> Kelas : XII RPL 1</h5><h5> Jurusan    : Rekayasa Perangkat Lunak</h5><h5>Sekolah  : SMKN 1 Purwosari</h5><h5> Tempat/Tanggal Lahir    : Pasuruan, 23 November 2003</h5>
                      <h5>Alamat    : Dsn. Jombor Atas, Desa lemahbang, kec. Sukorejo</h5>
                    </div>
                  </div>
                </div>	
              </div>
...
<script>
  ...
  </html><?php /**PATH C:\laravel\resources\views/profil.blade.php ENDPATH**/ ?>