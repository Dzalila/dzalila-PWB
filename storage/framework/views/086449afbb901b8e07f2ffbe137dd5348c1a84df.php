...
<html lang="en">
   <head>
      ...
      */
      ...
      .mybg-music {
        background: url(' image/pmng1.jpg') no-repeat center center fixed;
          background-size: cover;
      }
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading"> <span class="bg-main"></span></h3>
                    <br>
                    <h4 class="myp-slider text-center"><b>Scroll Kebawah Cuss</b></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">My Galeri</h3>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr1.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr1.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr2.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr2.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr3.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr3.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr4.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr4.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr5.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr5.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr6.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr6.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr7.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr7.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr8.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr8.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr9.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr9.jpg">
                    </a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-2 mt-4 gal-item wow bounceInUp" data-wow-duration="1.4s">
                <div class="music-gal item box">
                    <a href="image/gmbr10.jpg" class="fancybox" rel="ligthbox">
                    <img class="img-fluid" src="image/gmbr10.jpg">
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-left my-auto  wow zoomIn">
                    ...
                    <p style="color:dark(0, 0, 128);">* Dzalila Mustofa (09)</p>
                    <p style="color:dark(0, 0, 128);">* XII RPL 1</p>
                    <p style="color:dark(0, 0, 128);">* PWB</p>
                </div>
...
<?php /**PATH C:\laravel\resources\views/galeri.blade.php ENDPATH**/ ?>